...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       title="Home"
        ...
        sorry.text=sorry.text.toString().replace("User", "$first $last")
        ...
        val nama = v.findViewById(R.id.nama) as TextView
        nama.text="$first $last"
        val iduser = v.findViewById(R.id.iduser) as TextView
        iduser.text="@$uname"
